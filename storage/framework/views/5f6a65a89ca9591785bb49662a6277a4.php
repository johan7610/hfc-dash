            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                <div>
                    <h2 class="text-xl font-bold text-white leading-tight">
                        Agent Dashboard — <?php echo e($snapshot['month_label']); ?>

                    </h2>
                    <div class="text-sm text-white/60">
                        <?php echo e($snapshot['range']['start']); ?> → <?php echo e($snapshot['range']['end']); ?>
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                    <div>
                        <div class="ds-section-header" style="font-size:1.5rem;">
                            Your focus — <?php echo e($snapshot['month_label']); ?>
                    ...
                    <div class="flex flex-wrap md:flex-nowrap items-center gap-2">
                        <form method="GET" action="<?php echo e(route('agent.dashboard')); ?>" class="flex items-center gap-2">
                            <label class="text-sm font-semibold text-gray-700">Period</label>
                            <input type="month" class="h-10 px-2 text-sm w-auto" name="period" value="<?php echo e($snapshot['period'] ?? ''); ?>" />
                            <button type="submit" class="px-3 py-2 text-sm rounded-lg border bg-white hover:bg-gray-50">Go</button>
                        </form>

                        <a href="<?php echo e(route('agent.daily')); ?>" class="btn-primary inline-flex items-center justify-center min-h-[40px] px-4 whitespace-nowrap">
                            Daily Activity
                        </a>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div class="rounded-2xl border border-black/10 bg-gray-50 p-4">
                        <div class="flex items-end justify-between gap-4">
                            <div>
                                ...
                                <div class="text-3xl font-extrabold text-gray-900 leading-tight">
                                    <?php echo e(number_format($pointsActual, 1)); ?>

                                    <span class="text-gray-400 font-bold">/ <?php echo e(number_format($pointsTarget, 0)); ?></span>
                                    <?php if($pointsTarget > 0 && $pointsActual >= $pointsTarget): ?>
                                        <span title="Target achieved">🏆</span>
                                    <?php endif; ?>
                                </div>
                                <div class="text-sm text-gray-700 mt-1 font-semibold">
                                    Progress <?php echo e($p['points_pct'] ?? '—'); ?>%
                                </div>
                            </div>
                            ...
                            <div class="text-right">
                                ...
                                <div class="text-2xl font-extrabold text-gray-900 leading-tight">
                                    <?php echo e(number_format($pointsRemaining, 1)); ?>

                                </div>
                                <div class="text-sm text-gray-700 mt-1">
                                    Need <span class="font-bold"><?php echo e(number_format($pointsPerDayNeeded, 1)); ?></span>/day
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-2 ds-progress-track">
                            <div class="ds-progress-bar <?php echo e($pointsBarClass ?? 'ds-bar-navy'); ?>" style="width: <?php echo e($pointsPct); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl border border-black/10 bg-gray-50 p-4">
                        <div class="flex items-end justify-between gap-4">
                            <div>
                                ...
                                <div class="text-3xl font-extrabold text-gray-900 leading-tight">
                                    R <?php echo e(number_format((float)($a['sales_value'] ?? 0),0)); ?>

                                    <span class="text-gray-400 font-bold">/ R <?php echo e(number_format((float)($t['value_target'] ?? 0),0)); ?></span>
                                    <?php if(($t['value_target'] ?? 0) > 0 && ((float)($a['sales_value'] ?? 0) >= (float)($t['value_target'] ?? 0))): ?>
                                        <span title="Target achieved">🏆</span>
                                    <?php endif; ?>
                                </div>
                                <div class="text-sm text-gray-700 mt-1 font-semibold">
                                    Progress <?php echo e($p['value_pct'] ?? '—'); ?>%
                                </div>
                            </div>
                            ...
                            <div class="text-right">
                                <div class="text-sm text-gray-600 font-semibold">Remaining</div>
                                <div class="text-2xl font-extrabold text-gray-900 leading-tight">
                                    R <?php echo e(number_format(max(0, (float)($t['value_target'] ?? 0) - (float)($a['sales_value'] ?? 0)), 0)); ?>
                        ...
                        <div class="mt-2 ds-progress-track">
                            <div class="ds-progress-bar <?php echo e($valueBarClass); ?>" style="width: <?php echo e($valuePct); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div class="rounded-xl border border-black/10 bg-gray-50 p-4">
                        <div class="text-sm text-gray-600">Deals done</div>
                                                <div class="text-2xl font-bold text-gray-900"><?php echo e($a['deals_count']); ?></div>
                        <div class="mt-1 text-xs text-gray-500">All-time: <?php echo e($a['deals_count_all_time'] ?? 0); ?></div>
                    </div>
                    <div class="rounded-xl border border-black/10 bg-gray-50 p-4">
                        <div class="text-sm text-gray-600">Sales value</div>
                                                <div class="text-2xl font-bold text-gray-900">R <?php echo e(number_format((float)$a['sales_value'],0)); ?></div>
                        <div class="mt-1 text-xs text-gray-500">All-time: R <?php echo e(number_format((float)($a['sales_value_all_time'] ?? 0),0)); ?></div>
                    </div>
                    <div class="rounded-xl border border-black/10 bg-gray-50 p-4">
                        <div class="text-sm text-gray-600">Avg sale price (captured)</div>
                                                <div class="text-2xl font-bold text-gray-900">R <?php echo e(number_format((float)($a['avg_sale_price_actual'] ?? 0), 0)); ?></div>
                        <div class="mt-1 text-xs text-gray-500">All-time: R <?php echo e(number_format((float)($a['avg_sale_price_actual_all_time'] ?? 0), 0)); ?></div>
                    </div>
                    <div class="rounded-xl border border-black/10 bg-gray-50 p-4">
                        <div class="text-sm text-gray-600">Avg commission % (Ex VAT)</div>
                                                <div class="text-2xl font-bold text-gray-900"><?php echo e(number_format((float)($a['effective_commission_percent'] ?? 0), 2)); ?>%</div>
                        <div class="mt-1 text-xs text-gray-500">All-time: <?php echo e(number_format((float)($a['effective_commission_percent_all_time'] ?? 0), 2)); ?>%</div>
                    </div>

                    <div class="rounded-xl border border-black/10 bg-gray-50 p-4">
                        <div class="text-sm text-gray-600">Daily activity entries</div>

                                                <div class="text-2xl font-bold text-gray-900"><?php echo e($a['daily_rows']); ?></div>
                        <div class="mt-1 text-xs text-gray-500">All-time: <?php echo e($a['daily_rows_all_time'] ?? 0); ?></div>
                    </div>
                    <div class="rounded-xl border border-black/10 bg-gray-50 p-4">
<div class="text-sm text-gray-600">Listing stock</div>
                        <div class="mt-2 grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <div class="text-xl font-bold text-gray-900"><a class="underline hover:no-underline" href="<?php echo e(route('agent.listings', ['filter' => 'active'])); ?>"><?php echo e((int)($listingStats['total'] ?? 0)); ?></a></div>
                            </div>
                            <div>
                                <div class="text-xs text-gray-500">Avg DOM</div>
                                <div class="text-xl font-bold text-gray-900"><a class="underline hover:no-underline" href="<?php echo e(route('agent.listings', ['filter' => 'dom'])); ?>"><?php echo e((int)($listingStats['avg_days_on_market'] ?? 0)); ?></a></div>
                            </div>
                            <div>
                                <div class="text-xs text-gray-500">Stale (14d)</div>
                                <div class="text-xl font-bold text-gray-900"><a class="underline hover:no-underline" href="<?php echo e(route('agent.listings', ['filter' => 'stale'])); ?>"><?php echo e((int)($listingStats['stale'] ?? 0)); ?></a></div>
                            </div>
                            <div>
                                <div class="text-xs text-gray-500">Expiring (14d)</div>
                                <div class="text-xl font-bold text-gray-900"><a class="underline hover:no-underline" href="<?php echo e(route('agent.listings', ['filter' => 'expiring'])); ?>"><?php echo e((int)($listingStats['expiring_soon'] ?? 0)); ?></a></div>
                            </div>
                        </div>
                        <div class="mt-2 text-xs text-gray-500">Expired: <a class="underline hover:no-underline" href="<?php echo e(route('agent.listings', ['filter' => 'expired'])); ?>"><?php echo e((int)($listingStats['expired'] ?? 0)); ?></a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="ds-status-card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="rounded-2xl border border-black/10 bg-gray-50 p-4">
                    <div class="flex items-start justify-between gap-3">
                        <div>
                            ...
                            <div class="mt-1 text-2xl font-extrabold text-gray-900 leading-tight">
                                <?php echo e(number_format($youPointsA, 1)); ?>

                                <span class="text-gray-400 font-bold">/ <?php echo e(number_format($youPointsT, 0)); ?></span>
                                <?php if($youPointsT > 0 && $youPointsA >= $youPointsT): ?> <span title="Target achieved">🏆</span> <?php endif; ?>
                            </div>
                    ...
                    <div class="mt-3 ds-label">Points progress</div>
                    <div class="mt-2 ds-progress-track">
                        <div class="ds-progress-bar <?php echo e($barClass($youPointsPct)); ?>" style="width: <?php echo e((int)($youPointsPct ?? 0)); ?>%"></div>
                    </div>
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-3">
                          ...
                          <div>
                            ...
                            <div class="text-lg font-extrabold text-gray-900">
                                R <?php echo e(number_format($youValueA,0)); ?>

                            </div>
                            <div class="text-xs text-gray-500">
                                / R <?php echo e(number_format($youValueT,0)); ?>

                                <?php if($youValueT > 0 && $youValueA >= $youValueT): ?> <span title="Target achieved">🏆</span> <?php endif; ?>
                            </div>
                            <div class="mt-2 ds-progress-track">
                                <div class="ds-progress-bar <?php echo e($barClass($youValuePct)); ?>" style="width: <?php echo e((int)($youValuePct ?? 0)); ?>%"></div>
                            </div>
                        </div>
                    </div>

                    <div class="mt-4 text-xs text-gray-600">
                        Daily activity entries: <span class="font-bold text-gray-900"><?php echo e((int)($a['daily_rows'] ?? 0)); ?></span>
                    </div>
                </div>
                ...
                <div class="rounded-2xl border border-black/10 bg-gray-50 p-4">
                    ...
                    <?php if($cmpBranch): ?>
                        ...
                        <div class="mt-1 text-lg font-extrabold text-gray-900">
                            R <?php echo e(number_format($bValueA,0)); ?>

                            <span class="text-gray-400 font-bold">/ R <?php echo e(number_format($bValueT,0)); ?></span>
                            <?php if($bValueT > 0 && $bValueA >= $bValueT): ?> <span title="Target achieved">🏆</span> <?php endif; ?>
                        </div>
                        <div class="mt-2 ds-progress-track">
                            <div class="ds-progress-bar <?php echo e($barClass($bValuePct)); ?>" style="width: <?php echo e((int)($bValuePct ?? 0)); ?>%"></div>
                        </div>

                        <div class="mt-4 text-xs text-gray-600">
                            Daily activity entries: <span class="font-bold text-gray-900"><?php echo e((int)($cmpBranch['actuals']['daily_rows'] ?? 0)); ?></span>
                        </div>
                    <?php else: ?>
                ...
                <div class="rounded-2xl border border-black/10 bg-gray-50 p-4">
                    ...
                    <?php if($cmpCompany): ?>
                        <div class="mt-4 ds-label">Value progress</div>
                        <div class="mt-1 text-lg font-extrabold text-gray-900">
                            R <?php echo e(number_format($cValueA,0)); ?>

                            <span class="text-gray-400 font-bold">/ R <?php echo e(number_format($cValueT,0)); ?></span>
                            <?php if($cValueT > 0 && $cValueA >= $cValueT): ?> <span title="Target achieved">🏆</span> <?php endif; ?>
                        </div>
                        <div class="mt-2 ds-progress-track">
                            <div class="ds-progress-bar <?php echo e($barClass($cValuePct)); ?>" style="width: <?php echo e((int)($cValuePct ?? 0)); ?>%"></div>
                        </div>

                        <div class="mt-4 text-xs text-gray-600">
                            Daily activity entries: <span class="font-bold text-gray-900"><?php echo e((int)($cmpCompany['actuals']['daily_rows'] ?? 0)); ?></span>
                        </div>
                    <?php else: ?>
        ...
        <div class="ds-status-card">
            ...
            <div class="grid grid-cols-7 gap-2">
                <?php $__currentLoopData = $last7; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $d = $dt->toDateString();
                    ...
                    <div class="rounded-xl border border-black/10 bg-gray-50 p-2 text-center">
                        <div class="text-[10px] text-gray-600 font-semibold"><?php echo e($dt->format('D')); ?></div>
                        <div class="mt-2 h-16 flex items-end justify-center">
                            <div class="w-6 rounded" style="height: <?php echo e($h); ?>px; background: #0b2a4a;"></div>
                        </div>
                        <div class="mt-2 text-xs font-extrabold text-gray-900"><?php echo e(number_format($pts, 1)); ?></div>
                    </div>
            ...
            <div class="mt-4 flex items-center justify-between">
                <div class="text-sm text-gray-700">
                    Streak: <span class="font-extrabold text-gray-900"><?php echo e($streak); ?></span> day<?php echo e($streak === 1 ? '' : 's'); ?>

                </div>
                <div class="text-sm text-gray-600">
                    Today aim: <span class="font-bold text-gray-900"><?php echo e(number_format(max(10, round($pointsPerDayNeeded, 0)), 0)); ?></span> pts
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\johan\OneDrive\Documents\GitHub\hfc-dash\resources\views/agent/dashboard.blade.php ENDPATH**/ ?>