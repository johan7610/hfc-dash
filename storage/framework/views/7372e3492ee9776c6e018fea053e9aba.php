  ...
  <header>
    ...
    <div class="row">
      <div id="activeAgentDisplay" class="pill" style="border-color:rgba(255,255,255,0.18)">
        <span style="font-size:10px; opacity:0.7">User:</span> <b id="currentAgentName"><?php echo e(auth()->user()?->name ?? "User"); ?></b>
      </div>
      ...
      <table class="history-table">
        ...
        <div>
            ...
            <div class="pill" style="display:flex; align-items:center; justify-content:space-between; gap:10px;">
              <div>
                <div style="font-weight:900" id="authUserName"><?php echo e(auth()->user()?->name ?? "User"); ?></div>
                <div style="font-size:11px; opacity:0.8" id="authUserEmail"><?php echo e(auth()->user()?->email ?? ""); ?></div>
              </div>
              <div class="agent-tag" id="authUserRole" style="background:#0f172a; color:#fff; border-color:rgba(255,255,255,0.12);"><?php echo e(strtolower(trim((string)(auth()->user()?->effectiveRole() ?? (auth()->user()?->role ?? ""))))); ?></div>
            </div>
...
<script>
  window.DEFAULT_TAB = <?php echo json_encode($defaultTab, 15, 512) ?>;
  window.PRINT_SETTINGS = <?php echo json_encode($printSettings ?? null, 15, 512) ?>;
</script>
  ...
  ?>
  <script>
    window.AUTH_USER = <?php echo json_encode($AUTH_USER, 15, 512) ?>;
  </script>
...
<?php echo $__env->make('layouts.nexus', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\johan\OneDrive\Documents\GitHub\hfc-dash\resources\views/tools/tools.blade.php ENDPATH**/ ?>