...
<?php endif; ?>
<title>TV — <?php echo e($branchName); ?></title>
...
<div class="topbar">
  <div class="branch"><?php echo e($branchName); ?></div>
  ...
  <div class="statusbar" aria-label="Deal status summary">
    <div class="statusitem"><span class="statuslabel">Pending</span><span class="statusval"><?php echo e((int)($c['pending_period'] ?? 0)); ?></span></div>
    <div class="statusitem"><span class="statuslabel">Granted</span><span class="statusval"><?php echo e((int)($c['granted_period'] ?? 0)); ?></span></div>
    <div class="statusitem"><span class="statuslabel">Registered</span><span class="statusval"><?php echo e((int)($c['registered_period'] ?? 0)); ?></span></div>
    <div class="statusitem"><span class="statuslabel">Declined</span><span class="statusval"><?php echo e((int)($c['declined_period'] ?? 0)); ?></span></div>
  </div>
  ...
  <div class="listingbar" aria-label="Listing stock summary">
    <div class="listingitem"><span class="listinglabel">Active</span><span class="listingval"><?php echo e((int)($ls['total'] ?? 0)); ?></span></div>
    <div class="listingitem"><span class="listinglabel">Avg DOM</span><span class="listingval"><?php echo e((int)($ls['avg_days_on_market'] ?? 0)); ?></span></div>
    <div class="listingitem"><span class="listinglabel">Stale</span><span class="listingval"><?php echo e((int)($ls['stale'] ?? 0)); ?></span></div>
    <div class="listingitem"><span class="listinglabel">Expiring</span><span class="listingval"><?php echo e((int)($ls['expiring_soon'] ?? 0)); ?></span></div>
    <div class="listingitem"><span class="listinglabel">Expired</span><span class="listingval"><?php echo e((int)($ls['expired'] ?? 0)); ?></span></div>
  </div>

<div class="kpis">
  <div class="tile">
    <div class="label">Value</div>
    <div class="big">R <?php echo e(number_format($valueActual,0)); ?></div>
    <div class="sub">Target R <?php echo e(number_format($valueTarget,0)); ?></div>
    <div class="bar"><div class="fill" style="width:<?php echo e($valuePct); ?>%"></div></div>
  </div>
  <div class="tile">
    <div class="label">Points</div>
    <div class="big"><?php echo e(number_format($pointsActual,0)); ?></div>
    <div class="sub">Target <?php echo e(number_format($pointsTarget,0)); ?> • <?php echo e($pointsStatus); ?></div>
    <div class="bar"><div class="fill" style="width:<?php echo e($pointsPct); ?>%"></div></div>
  </div>
</div>
...
<div class="ticker">
  <span><?php echo e(implode('   •   ', $tickerMessagesFinal)); ?>   •   <?php echo e(implode('   •   ', $tickerMessagesFinal)); ?></span>
</div>

</div>

<script>
const msgs = <?php echo json_encode($messages, 15, 512) ?>;
let i = 0;
...
<?php /**PATH C:\Users\johan\OneDrive\Documents\GitHub\hfc-dash\resources\views/tv/branch.blade.php ENDPATH**/ ?>