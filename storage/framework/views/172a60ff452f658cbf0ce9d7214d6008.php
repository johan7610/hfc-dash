...
<div id="pdf-splitter-root">
    <div class="wrap">
        ...
        <div class="ds-status-card" style="border-left-color: var(--ds-cyan);">
            ...
            <form method="POST"
                  action="<?php echo e(route('tools.pdf_splitter.run')); ?>"
                ...
                <div class="field">
                    ...
                    <input type="text"
                           id="base_name"
                           name="base_name"
                           value="<?php echo e(old('base_name')); ?>"
                           maxlength="120"
                           placeholder="e.g. OceanView_Pack">
                    <?php $__errorArgs = ['base_name'];
...
<?php if(session('splitter_download_url')): ?>
    <iframe src="<?php echo e(session('splitter_download_url')); ?>" style="display:none; width:0; height:0; border:0;"></iframe>
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.nexus', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\johan\OneDrive\Documents\GitHub\hfc-dash\resources\views/tools/pdf_splitter.blade.php ENDPATH**/ ?>