...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
    ...
    <div style="background:#0b2a4a;" class="rounded-2xl px-6 py-4 flex items-center justify-between">
        ...
        <a href="<?php echo e(route('docuperfect.create')); ?>" class="nexus-btn-primary text-sm" style="background:rgba(255,255,255,0.15);">
            + Create New Document
        </a>
    </div>
    ...
    <?php if($documents->isEmpty()): ?>
        <div class="ds-status-card p-6 text-center">
            <div class="text-sm text-slate-500">No documents yet — <a href="<?php echo e(route('docuperfect.create')); ?>" class="ds-link">create one from a template</a>.</div>
        </div>
    <?php else: ?>
...
<?php echo $__env->make('layouts.nexus', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\johan\OneDrive\Documents\GitHub\hfc-dash\resources\views/docuperfect/dashboard.blade.php ENDPATH**/ ?>