...
<div class="text-right">
    <?php if($cmaVal !== ''): ?>
        <div class="font-semibold text-slate-900 dark:text-slate-100">R <?php echo e(number_format((float)$cmaVal, 0)); ?></div>
    <?php else: ?>
        —
    <?php endif; ?>
...
<?php echo $__env->make('layouts.nexus', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\johan\OneDrive\Documents\GitHub\hfc-dash\resources\views/bm/listings/index.blade.php ENDPATH**/ ?>