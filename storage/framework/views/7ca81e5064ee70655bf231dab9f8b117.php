...
<div class="container">
    <div class="card">
        ...
        <form method="POST" action="<?php echo e(route('tv.verify')); ?>" id="codeForm">
            <?php echo csrf_field(); ?>
        ...
        <?php if($errors->has('code')): ?>
            <div class="error-msg"><?php echo e($errors->first('code')); ?></div>
        <?php endif; ?>
    </div>
</div>
...
<?php /**PATH C:\Users\johan\OneDrive\Documents\GitHub\hfc-dash\resources\views/tv/index.blade.php ENDPATH**/ ?>