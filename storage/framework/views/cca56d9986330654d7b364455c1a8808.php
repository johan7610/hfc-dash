        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
            ...
            <div class="flex items-center gap-6">
                <div class="text-right">
                    ...
                    <div class="text-2xl font-bold text-white"><?php echo e($summary->total_count ?? 0); ?></div>
                </div>
                <div class="text-right">
                    <div class="text-xs uppercase tracking-wide text-white/60">Commission (Excl VAT)</div>
                    <div class="text-2xl font-bold text-white">R <?php echo e(number_format($summary->total_comm ?? 0, 2)); ?></div>
                </div>
                <a href="<?php echo e(route('rentals.create')); ?>" class="nexus-btn-primary">+ New Rental</a>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-wrap gap-3 mt-3">
            <?php $__currentLoopData = $summary_per_agent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2">
                    <div class="font-semibold text-slate-900 dark:text-slate-100"><?php echo e(data_get($a, 'name')); ?></div>
                    <div class="text-xs text-slate-500 dark:text-slate-400">
                        <?php echo e(data_get($a, 'rental_count', 0)); ?> rentals &mdash;
