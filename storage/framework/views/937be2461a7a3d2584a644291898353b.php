...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-[#00b4d8] shadow-sm focus:ring-[#00b4d8]" name="remember">
        ...
        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00b4d8]" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\USER-PC\Documents\Projects\hfc-dash\resources\views/auth/login.blade.php ENDPATH**/ ?>