...
Route::middleware(['auth', 'verified'])->prefix('corex')->group(function () {
    ...
    Route::prefix('rental-applications/authorisation')->group(function () {
        ...
        // Assessment add/edit/strike, 2026-09-08 — Johan: "so the auth can
        // verify working through the doc... they can add / edit / remove
        // (remove im thinking is just a strike out tick)."
        ...
        Route::put('/{rentalApplication}/assessment/income-items/{item}', [\App\Http\Controllers\CoreX\RentalApplicationAuthorisationController::class, 'updateIncomeItem'])->name('corex.rental-applications.authorisation.assessment.income-items.update');
        Route::put('/{rentalApplication}/assessment/expense-items/{item}', [\App\Http\Controllers\CoreX\RentalApplicationAuthorisationController::class, 'updateExpenseItem'])->name('corex.rental-applications.authorisation.assessment.expense-items.update');
