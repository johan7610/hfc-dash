        ...
        <div class="nexus-panel">
            ...
            <div class="nexus-panel-body">
                <div class="space-y-2">
                    ...
                    <a href="<?php echo e(route('admin.p24-suburbs.index')); ?>" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                        <div class="w-9 h-9 rounded-lg bg-sky-50 flex items-center justify-center flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-[#00b4d8]">
...
<?php echo $__env->make('layouts.nexus', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER-PC\Documents\Projects\hfc-dash\resources\views/nexus/settings.blade.php ENDPATH**/ ?>