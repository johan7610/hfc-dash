...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
    ...
    <div style="background: var(--brand-default, #0b2a4a);" class="rounded-md px-6 py-4">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            <div>
                <h2 class="text-xl font-bold text-white leading-tight tracking-tight">Company Listing Stock</h2>
    ...
    <div class="ds-status-card p-4 space-y-4">
        <form method="get" class="flex flex-wrap items-end gap-3">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.listings.stock') }}" class="px-3 py-1.5 rounded-md text-sm transition-all duration-300" style="border: 1px solid var(--border); color: var(--text-secondary);" onmouseover="this.style.background='var(--surface-2)'" onmouseout="this.style.background='transparent'">
                    Reset
                </a>
            </div>
        </form>
