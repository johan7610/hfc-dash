...
<div class="p-4" style="background:var(--surface-2, #f8fafc); border:1px solid var(--border, #e5e7eb); border-radius:6px;">
    ...
    <div class="mt-4">
        <a href="{{ route('staff-take-on.wizard', [$takeOn, 'personal']) }}" class="px-4 py-2 text-sm font-semibold text-white transition" style="background:var(--brand-icon); border-radius:6px;">Continue to Personal Details</a>
    </div>
</div>
