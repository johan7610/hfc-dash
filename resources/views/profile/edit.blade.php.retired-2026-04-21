        ...
        <form method="post" action="{{ route('profile.update') }}">
            ...
            <div style="margin-top:20px; padding-top:20px; border-top:1px solid var(--border);">
                ...
                <div style="max-width:320px;">
                    <div style="padding:9px 12px; border-radius:6px; background:var(--surface-2); border:1px solid var(--border); color:var(--text-primary); font-size:0.875rem;">{{ $user->designation ?: 'Not set' }}</div>
                    <p style="font-size:0.7rem; color:var(--text-muted); margin-top:4px;">Contact your branch manager or administrator to change your designation.</p>
                </div>
            </div>
