...
<div class="flex flex-col items-center justify-center py-20 text-center">
    <div class="text-6xl font-bold mb-2" style="color:var(--text-muted); opacity:0.3;">500</div>
    <h1 class="text-lg font-semibold mb-2" style="color:var(--text-primary);">Something went wrong</h1>
    <p class="text-sm mb-6" style="color:var(--text-muted);">An unexpected error occurred. Use the help widget to report this issue.</p>
