<div class="corex-header">
    ...
    <div class="corex-header-actions">
        {{-- Theme Toggle --}}
        <button type="button" class="corex-theme-toggle" id="corexThemeToggle" title="Toggle light/dark theme" onclick="(function(){var d=document.documentElement,dark=d.classList.toggle('dark');localStorage.setItem('corex-theme',dark?'dark':'light');})()">
