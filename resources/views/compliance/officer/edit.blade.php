            ...
            <form method="POST" action="{{ route('compliance.officer.update', $officer) }}" class="space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="full_name" value="{{ old('full_name', $officer->full_name) }}" required class="w-full px-3 py-2 text-sm border" style="border-color:var(--border, #e5e7eb); border-radius:3px;">
                    ...
                    <div>
                        ...
                        <input type="text" name="id_number" value="{{ old('id_number', $officer->id_number) }}" class="w-full px-3 py-2 text-sm border" style="border-color:var(--border, #e5e7eb); border-radius:3px;">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="cell" value="{{ old('cell', $officer->cell) }}" class="w-full px-3 py-2 text-sm border" style="border-color:var(--border, #e5e7eb); border-radius:3px;">
                    </div>
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email', $officer->email) }}" class="w-full px-3 py-2 text-sm border" style="border-color:var(--border, #e5e7eb); border-radius:3px;">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $officer->title) }}" class="w-full px-3 py-2 text-sm border" style="border-color:var(--border, #e5e7eb); border-radius:3px;">
                </div>
                ...
                <div>
                    ...
                    <textarea name="appointment_notes" rows="3" class="w-full px-3 py-2 text-sm border" style="border-color:var(--border, #e5e7eb); border-radius:3px;">{{ old('appointment_notes', $officer->appointment_notes) }}</textarea>
                </div>
