                ...
                <div class="bg-white border border-slate-200 p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <a href="https://tfs.fic.gov.za/Pages/Search" target="_blank" rel="noopener"
                           class="inline-flex items-center gap-1.5 px-3 py-1.5 border border-slate-300 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition mb-2">
                        ...
                        <p class="text-xs text-slate-400 mb-2">Search for <strong>{{ $submission->contact?->full_name ?? 'the client' }}</strong> on the FIC Targeted Financial Sanctions list</p>
